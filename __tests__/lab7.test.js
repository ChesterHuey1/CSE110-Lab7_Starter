describe('Basic user flow for Website', () => {
  ...
  // We use  () here because this test has a TODO that has not been completed yet.
  // Make sure to remove the   after you finish the TODO.
  it ('Make sure <product-item> elements are populated', async () => {
    ...
    allArePopulated = await page.$$eval('product-item', items => {
      return items.every(item => {
        const data = item.data;
        return data &&
               data.title && data.title.length &&
               data.price && data.price.toString().length &&
    ...
    * Remove the   from this it once you are finished writing this test.
    */
  ...
  it ('Clicking the "Add to Cart" button should change button text', async () => {
     ...
     * Remember to remove the   from this it once you are finished writing this test.
     */
  ...
  it ('Checking number of items in cart on screen', async () => {
     ...
     */
       ...
       const count = await page.$eval('#cart-count', el => el.textContent);
     ...
     */
       ...
       const allButtonsRemove = await page.$$eval('product-item', items => {
         return items.every(item => {
           ...
           return shadowButton === 'Remove from Cart';
         });
       });
